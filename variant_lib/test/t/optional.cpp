...
#include <variant_lib/optional.hpp>
...
{
    variant_lib::optional<int> dbl_opt;
...
TEST_CASE("copy c'tor", "[optional]")
{
    ...
    variant_lib::optional<int> other = dbl_opt;
...
{
    const variant_lib::optional<int> dbl_opt = 3;
...
{
    variant_lib::optional<int> dbl_opt = 3;
...
{
    variant_lib::optional<dummy> dummy_opt;
    REQUIRE(!dummy_opt);
...
{
    variant_lib::optional<int> a;
    variant_lib::optional<int> b;
