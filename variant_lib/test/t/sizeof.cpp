...
using variant_internal_index_type = variant_lib::type_index_t;
...
TEST_CASE("size of variants")
{
    ...
    using v1 = variant_lib::variant<int>;
    using v2 = variant_lib::variant<int, bool, int64_t>;
    using v3 = variant_lib::variant<int, std::string>;
    using v4 = variant_lib::variant<std::string, std::string>;
    using v5 = variant_lib::variant<some_struct>;
